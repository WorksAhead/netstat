...
namespace ttcp
{
    ...
    public:
        ...
        TTcpClient(const std::string& address, const std::string& port, uint32_t notifyInterval);
        ~TTcpClient();
    ...
    private:
        ...
        uint32_t m_NotifyInterval{1000};
        ...
        boost::chrono::microseconds m_TotalWriteTime;
